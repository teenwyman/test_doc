...
| end_date | issue_date<br>days_supply | issue_date + COALESCE(days_supply, 0) -1 | **The observation_period_end_date does not take days_supply into account, meaning the end_date may be extend beyond the observation period when days_supply is added.** |
| start_time | | 00:00:00 |
